...
public class AbHttpClient {
	 ...
	 * @param map
	 */
	public void addHeaders(HashMap<String, Object> map) {
		mHashMap = map;
	}
...
//							((AbStringHttpResponseListener)responseListener).onSuccess((Integer) response[0],(String)response[1]);
							((AbStringHttpResponseListener) responseListener).onSuccess((Integer) response[0], (String) response[1], (Header[]) response[2]);
						}else{
            ...
            if (statusCode == HttpStatus.SC_OK) {
                ...
                if (entity != null){
	  				  if(mResponseListener instanceof AbStringHttpResponseListener){
						  ...
						  ((AbStringHttpResponseListener) mResponseListener).sendSuccessMessage(statusCode, responseBody, headers);
