...
public class ChangeBirthDialog extends Dialog implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        initMonths(month);
        int mon = setMonth(currentMonth);
        mMonthAdapter = new CalendarTextAdapter(context, arry_months, mon, maxTextSize, minTextSize);
    ...
    public void setDayVisible(int isShow){
        if(wvDay!=null){
            wvDay.setVisibility(isShow);
        }
    }
